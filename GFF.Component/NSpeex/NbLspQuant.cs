...
{
	internal class NbLspQuant : LspQuant
	{
		...
		public sealed override void Unquant(float[] lsp, int order, Bits bits)
		{
			...
			base.UnpackPlus(lsp, Codebook_Constants.cdbk_nb_low2, bits, 0.00097656f, 5, 0);
			base.UnpackPlus(lsp, Codebook_Constants.cdbk_nb_high1, bits, 0.0019531f, 5, 5);
			base.UnpackPlus(lsp, Codebook_Constants.cdbk_nb_high2, bits, 0.00097656f, 5, 5);
		}
	}
}
